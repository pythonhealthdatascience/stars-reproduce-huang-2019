...
I add `libicu-dev` and tried again.

I decided to try out `containerit`, given the number of issues I have faced trying to create the dockerfile from scratch. I add `containerit` (and its dependencies) to the renv. I then ran:
