...
I found [this issue](https://github.com/Bioconductor/bioconductor_docker/issues/59) with the same error, where it appears there is an issue with the stringr binary being built for the wrong Ubunutu since `libicui18n.so.66` is for 20.04, although the fix appeared to be that they fixed the bioconductor container, and it wasn't super clear to me what I should do.
